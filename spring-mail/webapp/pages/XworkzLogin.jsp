	...
	<div class="container" align="center">
		...
		<div class="card bg-light" style="align-items: center;">
			<article class="card-body mx-auto"
				...
				<form action="sendMail.odc" method="post">
					TO:<div class="form-group input-group">
						<div class="input-group-prepend">
							<span class="input-group-text"> <i class="fa fa-envelope"></i>
							</span>
						</div>
						<input name="toMail" class="form-control"
							placeholder="Enter Reciver EmailID" type="email"
							value="${dto.toMail}" />
					</div>	
					SUBJECT:<div class="form-group input-group">
						<div class="input-group-prepend">
							<span class="input-group-text"> <i class="fa fa-envelope"></i>
							</span>
						</div>
						<input name="subject" class="form-control"
							placeholder="Enter Subject" type="text" value="${dto.subject}" />
					</div>
					BODY:<div class="form-group input-group">
						...
						<textarea name="body" class="form-control"
							placeholder="Enter text" rows="4" cols="10"></textarea>
					</div>
